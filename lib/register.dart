            ...
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 40),
                child: Container(
                  ...
                  child: TextFormField(
                    validator: (val) => val.length <2 ? 'Hãy nhập họ và tên' : null,
                    onChanged: (val){
                      setState(()=> name = val);
                    },
                    obscureText: false,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: (val) => val.length <2 ? 'Hãy nhập ngày sinh' : null,
                      onChanged: (val){
                        setState(()=> dayofbirth = val);
                      },
                      obscureText: false,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: (val) => val.length <2 ? 'Hãy nhập số điện thoại' : null,
                      onChanged: (val){
                        setState(()=> phone = val);
                      },
                      obscureText: false,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: (val) => val.length <2 ? 'Hãy nhập tên đăng nhập' : null,
                      onChanged: (val){
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: (val) => val.length <2 ? 'Hãy nhập mật khẩu' : null,
                      onChanged: (val){
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: (val) => val.length <2 ? 'Hãy nhập email' : null,
                      onChanged: (val){
                        setState(()=> email = val);
                      },
                      obscureText: false,
