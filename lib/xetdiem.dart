...
class xetDiemPage extends StatefulWidget {
  final Function toggleView;

  xetDiemPage({this.toggleView});

  @override
  _xetDiemPageState createState() => _xetDiemPageState();
}
enum GioiTinh { Nam, Nu }
class _xetDiemPageState extends State<xetDiemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('ĐĂNG KÝ XÉT TUYỂN ĐIỂM'),
      ),
